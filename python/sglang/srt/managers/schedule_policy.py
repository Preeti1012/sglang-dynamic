...
class SchedulePolicy:
    ...
    def calc_priority(self, waiting_queue: List[Req]) -> bool:
        if self.policy == CacheAgnosticPolicy.FCFS:
            # logger.info("##### schedule_policy: FCFS #####")
            # A shortcut for FCFS
            return False
    ...
    def _determine_active_policy(self, waiting_queue: List[Req]) -> Policy:
        # logger.info("##### schedule_policy: _determine_active_policy #####")
    ...
    def _validate_and_adjust_policy(
        ...
        try:
            ...
            if getattr(tree_cache, "disable", True):
                # logger.info("##### schedule_policy: _validate_and_adjust_policy CacheAgnosticPolicy #####") 
                # If tree_cache is disabled, using CacheAgnosticPolicy policy
                return CacheAgnosticPolicy.FCFS
            # logger.info("##### schedule_policy: _validate_and_adjust_policy CacheAwarePolicy #####") 
            return policy_enum
        except ValueError:
            try:
    ...
    def _compute_prefix_matches(
        ...
        """
        # logger.info("##### schedule_policy: _compute_prefix_matches #####")
    ...
    def _sort_by_longest_prefix(
        ...
        # logger.info("##### schedule_policy: _sort_by_longest_prefix #####")
        waiting_queue.sort(
            key=lambda r: (
    ...
    def _sort_by_dfs_weight(
        ...
        # logger.info("##### schedule_policy: _sort_by_dfs_weight #####")
    ...
    def _sort_by_longest_output(waiting_queue: List[Req]) -> None:
        ...
        # logger.info("##### schedule_policy: _sort_by_longest_output #####")
        waiting_queue.sort(key=lambda x: -x.sampling_params.max_new_tokens)

    @staticmethod
    def _sort_randomly(waiting_queue: List[Req]) -> None:
        """Shuffles the waiting queue randomly."""
        # logger.info("##### schedule_policy: _sort_randomly #####")
        random.shuffle(waiting_queue)

    @staticmethod
    def _calc_weight(cur_node: TreeNode, node_to_weight: Dict[TreeNode, int]) -> None:
        # logger.info("##### schedule_policy: _calc_weight #####")
    ...
    def _get_dfs_priority(
        ...
        # logger.info("##### schedule_policy: _get_dfs_priority #####")
...
class PrefillAdder:
    ...
    def rem_total_tokens(self):
        if self.is_hybrid:
            ...
            # logger.info(f"##### SchedulePolicy rem_total_tokens is_hybrid: available_and_evictable: {available_and_evictable} self.rem_total_token_offset: {self.rem_total_token_offset} #####\n")
        else:
            available_and_evictable = (
                self.token_to_kv_pool_allocator.available_size()
                + self.tree_cache.evictable_size()
            )
            # logger.info(f"##### SchedulePolicy rem_total_tokens is_not_hybrid: available_and_evictable: {available_and_evictable} self.rem_total_token_offset: {self.rem_total_token_offset} #####\n")
    ...
    def cur_rem_tokens(self):
        if self.is_hybrid:
            ...
            # logger.info(f"##### SchedulePolicy cur_rem_tokens is_hybrid: available_and_evictable: {available_and_evictable} self.rem_total_token_offset: {self.rem_total_token_offset} #####\n")
        else:
            available_and_evictable = (
                self.token_to_kv_pool_allocator.available_size()
                + self.tree_cache.evictable_size()
            )
            # logger.info(f"##### SchedulePolicy cur_rem_tokens is_not_hybrid: available_and_evictable: {available_and_evictable} self.rem_total_token_offset: {self.rem_total_token_offset} #####\n")
    ...
    def _update_prefill_budget(
        ...
        # logger.info(f"##### schedule_policy: _update_prefill_budget:  self.log_hit_tokens(+= prefix_len)={ self.log_hit_tokens} #####")
    ...
    def add_one_req(self, req: Req, has_chunked_req: bool):
        ...
        # logger.info(f"##### schedule_policy: add_one_req: prefix_len(len(req.prefix_indices))={prefix_len} #####")
