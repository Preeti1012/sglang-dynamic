...
class Engine(EngineBase):
    ...
    async def async_generate(
        ...
        # logger.info("##### Engine async_generate #####")
    ...
    async def async_encode(
        ...
        # logger.info("##### Engine async_encode #####")
    ...
    def __enter__(self):
        # logger.info("##### Engine __enter__ #####")
        return self

    def __exit__(self, exc_type, exc_value, traceback):
        # logger.info("##### Engine __exit__ #####")
        self.shutdown()
        return False

    def flush_cache(self):
        # logger.info("##### Engine flush_cache #####")
        loop = asyncio.get_event_loop()
        return loop.run_until_complete(self.tokenizer_manager.flush_cache())

    def start_profile(self):
        # logger.info("##### Engine start_profile #####")
        loop = asyncio.get_event_loop()
        loop.run_until_complete(self.tokenizer_manager.start_profile())

    def stop_profile(self):
        # logger.info("##### Engine stop_profile #####")
        loop = asyncio.get_event_loop()
        loop.run_until_complete(self.tokenizer_manager.stop_profile())

    def start_expert_distribution_record(self):
        # logger.info("##### Engine start_expert_distribution_record #####")
        loop = asyncio.get_event_loop()
    ...
    def stop_expert_distribution_record(self):
        # logger.info("##### Engine stop_expert_distribution_record #####")
        loop = asyncio.get_event_loop()
        loop.run_until_complete(
    ...
    def dump_expert_distribution_record(self):
        # logger.info("##### Engine dump_expert_distribution_record #####")
        loop = asyncio.get_event_loop()
        loop.run_until_complete(
    ...
    def get_server_info(self):
        # logger.info("##### Engine get_server_info #####")
        loop = asyncio.get_event_loop()
    ...
    def init_weights_update_group(
        ...
        # logger.info("##### Engine init_weights_update_group #####")
    ...
    def update_weights_from_distributed(
        ...
        # logger.info("##### Engine update_weights_from_distributed #####")
    ...
    def update_weights_from_tensor(
        ...
        # logger.info("##### Engine update_weights_from_tensor #####")
    ...
    def update_weights_from_disk(
        ...
        # logger.info("##### Engine update_weights_from_disk #####")
    ...
    def get_weights_by_name(self, name: str, truncate_size: int = 100):
        ...
        # logger.info("##### Engine get_weights_by_name #####")
    ...
    def load_lora_adapter(self, lora_name: str, lora_path: str, pinned: bool = False):
        ...
        # logger.info("##### Engine load_lora_adapter #####")
    ...
    def unload_lora_adapter(self, lora_name: str):
        ...
        # logger.info("##### Engine unload_lora_adapter #####")
    ...
    def release_memory_occupation(self, tags: Optional[List[str]] = None):
        # logger.info("##### Engine release_memory_occupation #####")
    ...
    def resume_memory_occupation(self, tags: Optional[List[str]] = None):
        # logger.info("##### Engine resume_memory_occupation #####")
...
def _init_tokenizer_manager(
    ...
    # logger.info("##### Engine: _init_tokenizer_manager #####")
...
def _launch_subprocesses(
    ...
    """
    # logger.info("##### Engine: _launch_subprocesses #####")
