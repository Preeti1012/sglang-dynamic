...
async def init_multi_tokenizer() -> ServerArgs:
    ...
    # logger.info("##### init_multi_tokenizer #####")
...
async def lifespan(fast_api_app: FastAPI):
    ...
    # logger.info("##### @asynccontextmanager lifespan #####")
...
async def health_generate(request: Request) -> Response:
    ...
    # logger.info("##### @app.api_route(/health_generate) #####")
...
async def get_model_info():
    ...
    # logger.info("##### @app.api_route(/get_model_info) #####")
...
async def get_server_info():
    # logger.info("##### @app.api_route(/get_server_info) #####")
...
@app.get("/get_load")
async def get_load():
    # logger.info("##### @app.api_route(/get_load) #####")
...
async def generate_request(obj: GenerateReqInput, request: Request):
    ...
    if obj.stream:
        # logger.info("##### @app.api_route(/generate, methods=[POST, PUT]) obj.stream: tokenizer_manager.generate_request #####")
        ...
        # logger.info("##### @app.api_route(/generate, methods=[POST, PUT]) not obj.stream: tokenizer_manager.generate_request #####")
        try:
...
async def generate_from_file_request(file: UploadFile, request: Request):
    ...
    # logger.info("##### @app.api_route(/generate_from_file, methods=[POST]) #####")
...
async def encode_request(obj: EmbeddingReqInput, request: Request):
    ...
    # logger.info("##### @app.api_route(/encode, methods=[POST, PUT]) #####")
...
async def update_weights_from_disk(obj: UpdateWeightFromDiskReqInput, request: Request):
    ...
    # logger.info("##### @app.post(/update_weights_from_distributed) #####")
...
async def init_weights_update_group(
    ...
    # logger.info("##### @app.post(/init_weights_update_group) #####")
...
async def update_weights_from_tensor(
    ...
    # logger.info("##### @app.post(/update_weights_from_tensor) #####")
...
async def continue_generation(request: Request):
    """Continue generation."""
    # logger.info("##### @app.post(/continue_generation) continue_generation #####")
...
async def openai_v1_completions(request: CompletionRequest, raw_request: Request):
    ...
    # logger.info("##### @app.post(/v1/completions) openai_v1_completions #####")
...
async def openai_v1_chat_completions(
    ...
    # logger.info("##### @app.post(/v1/chat/completions) openai_v1_chat_completions #####")
...
async def openai_v1_embeddings(request: EmbeddingRequest, raw_request: Request):
    ...
    # logger.info("##### @app.post(/v1/embeddings) openai_v1_embeddings #####")
...
async def v1_score_request(request: ScoringRequest, raw_request: Request):
    ...
    # logger.info("##### @app.post(/v1/score) v1_score_request #####")
...
async def v1_responses_request(request: dict, raw_request: Request):
    ...
    # logger.info("##### @app.post(/v1/responses) v1_responses_request #####")
...
async def v1_retrieve_responses(response_id: str, raw_request: Request):
    ...
    # logger.info("##### @app.get(/v1/responses/{response_id}) v1_retrieve_responses #####")
...
async def v1_cancel_responses(response_id: str, raw_request: Request):
    ...
    # logger.info("##### @app.post(/v1/responses/{response_id}/cancel) v1_cancel_responses #####")
...
async def v1_rerank_request(request: V1RerankReqInput, raw_request: Request):
    ...
    # logger.info("##### @app.post(/v1/rerank) v1_rerank_request #####")
...
def launch_server(
    ...
    # logger.info("##### http_server: launch_server #####")

    if server_args.tokenizer_worker_num > 1:
        # logger.info("##### http_server: launch_server http_server/multi_tokenizer_router #####")
        ...
        # logger.info("##### http_server: launch_server http_server/tokenizer_manager #####")
    ...
    if server_args.tokenizer_worker_num > 1:
        # logger.info("#####tokenizer_worker_num > 1#####")
...
def _execute_server_warmup(
    ...
    # logger.info("##### _execute_server_warmup #####")
    headers = {}
    url = server_args.url()
    if server_args.api_key:
